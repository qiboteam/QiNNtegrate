...
plt.grid(True)
plt.subplots(2, 1, sharex=True, gridspec_kw={'height_ratios':[2,1]})

plt.subplot(2, 1, 1)
plt.plot(xlin, target_vals, alpha=0.6, label="Exact", linewidth=1.5, ls="-")
plt.plot(xlin, circuit_vals, alpha=0.7, label="Circuit", linewidth=1.5, ls="-.")
...
plt.plot(xlin, rr, color="black", alpha=0.5, label="Error")
plt.ylabel("% error")
# plt.legend()
plt.grid(True)
